        ...
        <div class="col">
            <div class="row mb-3">
                <div class="col">
                    ...
                    <div class="row mb-3 animated fadeInDown fast">
                        <div class="col">
                            <validation-wrapper-component :validator="$v.parameters.head_id">
                                <selectable-component  :endpoint="route('api.account.user.list')" section="userSection" valueColumn="id" labelColumn="name" v-model="parameters.head_id"></selectable-component>
                                <span>head</span>
                            </validation-wrapper-component>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            submitForm(){
                this.submit((this.data ? this.route('api.department.update', this.data.id) : this.route('api.department.create')), (this.data ? 'put' : 'post'), this.section+'.form', true, true)
            },
            successHandler(){
                this.crudSuccess();
            }
