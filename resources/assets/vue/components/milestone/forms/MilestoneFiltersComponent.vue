                    ...
                    <div class="row mb-3 animated fadeInDown fast">
                        <div class="col">
                            <label class="form-group has-float-label mb-1">
                                <selectable-component  :endpoint="route('api.modular_type.list')" section="modularTypeSection" valueColumn="id" labelColumn="name" v-model="parameters.project_type"></selectable-component>
